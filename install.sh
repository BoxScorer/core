...
echo 'alias boxingpoints="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/BoxScorer/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/BoxScorer/core'"
...
rm -rf "$HOME/.config/@boxingpoints"
rm -rf "$HOME/.config/@boxingpoints"
rm -rf "$HOME/.config/boxingpoints-core"
